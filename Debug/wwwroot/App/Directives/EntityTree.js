        ...
        function link($scope, $element, $attrs) {
            ...
            $scope.contextMenu = [
                { // Add (folder)
                    ...
                    click: function () {
                        entityService.createEntity($scope, entityService.calculatePath($scope.connection.selectedNode) + "/" + findUniqueName($scope.connection.selectedNode, $scope.connection.selectedNode.Name));
                        return true;
                    },
                ...
                { // Remove (element)
                    text: 'Remove', 
                    click: function () {
                        entityService.deleteEntity($scope, entityService.calculatePath($scope.connection.selectedNode));
                    },

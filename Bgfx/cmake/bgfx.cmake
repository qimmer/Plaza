...
add_library( bgfxlib ${BGFX_SOURCES} )

# Enable BGFX_CONFIG_DEBUG in Debug configuration
target_compile_definitions( bgfxlib PRIVATE "$<$<CONFIG:Debug>:BGFX_CONFIG_DEBUG=1>" )
if(BGFX_CONFIG_DEBUG)
	target_compile_definitions( bgfxlib PRIVATE BGFX_CONFIG_DEBUG=1)
endif()

# Special Visual Studio Flags
if( MSVC )
	target_compile_definitions( bgfxlib PRIVATE "_CRT_SECURE_NO_WARNINGS" )
endif()

# Includes
target_include_directories( bgfxlib PRIVATE ${BGFX_DIR}/3rdparty ${BGFX_DIR}/3rdparty/dxsdk/include ${BGFX_DIR}/3rdparty/khronos )
target_include_directories( bgfxlib PUBLIC ${BGFX_DIR}/include )

# bgfx depends on bx and bimg
target_link_libraries( bgfxlib PUBLIC bx bimg )

# ovr support
if( BGFX_USE_OVR )
	target_link_libraries( bgfxlib PUBLIC ovr )
endif()
...
if( APPLE )
	...
	target_link_libraries( bgfxlib PUBLIC ${COCOA_LIBRARY} ${METAL_LIBRARY} ${QUARTZCORE_LIBRARY} )
endif()
...
if( UNIX AND NOT APPLE )
	...
	target_link_libraries( bgfxlib PUBLIC ${X11_LIBRARIES} ${OPENGL_LIBRARIES})
endif()
...
set_target_properties( bgfxlib PROPERTIES FOLDER "bgfx" )

# Export debug build as "bgfxd"
set_target_properties( bgfxlib PROPERTIES OUTPUT_NAME_DEBUG "bgfxd" )

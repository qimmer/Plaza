...
template<typename T> using Vector = std::vector<T, MyAlloc<T>>;
template<typename T> using Set = std::unordered_set<T, MyAlloc<T>>;
template<typename T, typename Comparator = std::less<T>> using OrderedSet = std::set<T, Comparator, MyAlloc<T>>;
